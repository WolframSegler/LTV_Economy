...
import wfg.ltv_econ.util.RfReflectionUtils.ObfuscatedClasses;

/**
 * Listener factory by rolfosian.
 * https://github.com/rolfosian/UnnamedStarsectorFleetPresetMod/blob/main/src/data/scripts/util/ListenerFactory.java
 */
public class ListenerFactory {
    ...
    static {
        ...
        Object optionPanelGetButtonToItemMapMethod = null;
        Object interactionDialogGetCoreUIMethod = null;
        ...
        for (int i = 0; i < obfClasses.length; i++) {
            ...
            if (optionPanelGetButtonToItemMapMethod == null && OptionPanelAPI.class.isAssignableFrom(cls)) {
                optionPanelGetButtonToItemMapMethod = RfReflectionUtils.getMethod(
                    "getButtonToItemMap", cls, 0
                );
                continue;
            }
            ...
            if (buttonClass == null && ButtonAPI.class.isAssignableFrom(cls)) {
                buttonClass = cls;
                Object buttonGetListenerMethod = RfReflectionUtils.getMethod("getListener", buttonClass, 0);
    ...
    static {
        ...
        Class<?> dialogDismissedParamClass = RfReflectionUtils.getMethodParamTypes(dialogDismissedInterface.getDeclaredMethods()[0])[0];
        ...
        try {
            ...
            factoryType = MethodType.methodType(actionListenerInterface, ActionListenerProxy.class);
