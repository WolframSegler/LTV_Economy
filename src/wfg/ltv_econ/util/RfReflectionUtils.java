...
/**
 * ReflectionUtils by rolfosian.
 * https://github.com/rolfosian/UnnamedStarsectorFleetPresetMod/blob/main/src/data/scripts/util/ReflectionUtilis.java
 */
public class RfReflectionUtils {
    private static final Logger logger = Logger.getLogger(RfReflectionUtils.class);
        ...
        try {
            ...
            while (currentClass != null) {
                for (Object field : currentClass.getDeclaredFields()) {
                    ...
                    // }
                    try {
                        RfReflectionUtils.logConstructors(fieldType);
                    } catch (Exception e) {
                        print(e);
                    }
                    i++;
