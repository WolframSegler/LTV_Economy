...
public class FactionResourcesTable extends CustomPanel implements HasBackground {
    ...
    public void buildUI() {
        ...
        table.addHeaders(
            ...
            "Demand", 95, "Daily demand across all faction markets.", false, false, -1,
            "Production", 120, "Daily production across all faction markets.", false, false, -1,
            ...
            "Balance", 100, "Net daily flow of this commodity for your faction, after production, consumption, and trade.", false, false, -1,
            "Autarky", 95, "Fraction of total demand satisfied using only in-faction production. Shows how self-sufficient your faction is for this commodity.", false, false, -1
        );
