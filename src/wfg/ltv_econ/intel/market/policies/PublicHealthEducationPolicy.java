...
public class PublicHealthEducationPolicy extends MarketPolicy {
    ...
    public void createTooltip(PlayerMarketData data, TooltipMakerAPI tp) {
        ...
        tp.addToGrid(0, 1, str("marketPopDataHappinessTxt"), String.format("%+.2f", HAPPINESS_DEBUFF), negative);
        tp.addToGrid(0, 2, str("marketPopDataCohesionTxt"), String.format("%+.2f", COHESION_BUFF));
